...
export let options = {
  ...
  stages: [
    { duration: '10s', target: 10 },     // aquecer: 10 VUs
    { duration: '1m', target: 2000 },    // aumenta a carga
    { duration: '10m', target: 2000 },   // carga principal: 1000 VUs
    { duration: '15s', target: 10 },     // retira a carga
  ],
